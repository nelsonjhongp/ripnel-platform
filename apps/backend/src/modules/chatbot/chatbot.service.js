...
async function handleGetTodayMetrics(args, userId) {
...
async function handleGetSalesSummary(args) {
...
async function handleGetStock(args) {
  if (!args.style_id) {
...
async function handleGetInventoryAlerts() {
  const result = await query(
    `SELECT
...
async function handleGetCashStatus(args, userId) {
...
async function handleObtenerTopProductos(args) {
...
async function handleSearchProductsByName(args) {
...
async function handleSearchCustomersByName(args) {
...
async function handleGetLatestSales() {
  const result = await query(
...
async function handleGetUserSession(args, userId) {
  const result = await query(
...
function handleCalculatePercentage(args) {
...
function handleCalculateDiscount(args) {
...
function handleGetModuleHelp(args) {
  const helpMap = {
...
async function handleGetSalesByDateRange(args) {
...
const FUNCTION_HANDLERS = {
  get_today_metrics: handleGetTodayMetrics,
  get_sales_summary: handleGetSalesSummary,
  get_stock: handleGetStock,
  get_inventory_alerts: handleGetInventoryAlerts,
  get_pending_transfers: handleGetPendingTransfers,
  get_cash_status: handleGetCashStatus,
  obtener_top_productos: handleObtenerTopProductos,
  search_products_by_name: handleSearchProductsByName,
  search_customers_by_name: handleSearchCustomersByName,
  get_latest_sales: handleGetLatestSales,
  get_user_session: handleGetUserSession,
  calculate_percentage: handleCalculatePercentage,
  calculate_discount: handleCalculateDiscount,
  get_system_info: handleGetSystemInfo,
  get_module_help: handleGetModuleHelp,
  calculate: handleCalculate,
  get_sales_by_date_range: handleGetSalesByDateRange,
};
