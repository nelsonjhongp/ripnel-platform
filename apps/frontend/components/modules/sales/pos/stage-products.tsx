              ...
              <table className="w-full border-collapse">
                <thead className="sticky top-0 z-10">
                  <tr className="text-left text-xs font-semibold uppercase tracking-[0.16em] text-[var(--ops-text-muted)]">
                    ...
                    <th className={TH_CLASS}>Variante</th>
                    <th className={cn(TH_CLASS, "text-center")}>Cant.</th>
                    <th className={cn(TH_CLASS, "text-right")}>Precio unit.</th>
                    <th className={cn(TH_CLASS, "text-right")}>Subtotal</th>
                    <th className={cn(TH_CLASS, "text-right")} aria-label="Acciones" />
                  </tr>
                </thead>
                      ...
                      <td className={TD_CLASS}>
                        ...
                        {item.price_override?.reason ? (
                          <p className="mt-1 text-[11px] text-[var(--ripnel-accent-hover)]">
                            Ajuste: {item.price_override.reason}
                          </p>
                        ) : null}
                      </td>
